# Generated by Powerlevel10k configuration wizard on 2023-04-30 at 14:14 JST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND='#FCA17D'
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND='#FCA17D'
  ...
  # Hint: https://github.com/romkatv/powerlevel10k/issues/1865#issuecomment-1125853266
  typeset -g POWERLEVEL9K_VCS_{STAGED,UNSTAGED,UNTRACKED,CONFLICTED,COMMITS_AHEAD,COMMITS_BEHIND}_ICON=
  # Disable gitstatusd
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND='#86BBD8'
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND='#047E84'
